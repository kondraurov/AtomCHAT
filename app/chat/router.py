...
from app.chat.dao import get_all_chats
from app.database import get_db
from app.chat.schemas import MessageSchema  # Импортируем Pydantic-схему
from app.users.dependencies import get_current_moderator, get_current_user
...
# Просмотр всех чатов для модератора по этому энд-поинту
@router.get("/all_dialogues", response_model=List[MessageSchema])  # Используем Pydantic-схему
